...
namespace CastService.Web.Controllers
{
    public class Customers1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Eik,Address,Place,Note,IsDeleted,DeletedOn,CreatedOn,ModifiedOn")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Eik,Address,Place,Note,IsDeleted,DeletedOn,CreatedOn,ModifiedOn")] Customer customer)
        {
            if (ModelState.IsValid)
            {
